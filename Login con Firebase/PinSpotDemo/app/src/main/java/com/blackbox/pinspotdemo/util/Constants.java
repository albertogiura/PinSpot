...
public class Constants {
    ...
    public static final String SHARED_PREFERENCES_FILE_NAME = "com.blackbox.pinspotdemo.preferences";
    ...
    public static final String ENCRYPTED_SHARED_PREFERENCES_FILE_NAME = "com.blackbox.pinspotdemo.encrypted_preferences";
    public static final String EMAIL_ADDRESS = "email_address";
    public static final String PASSWORD = "password";
    public static final String ID_TOKEN = "google_token";

    // Constants for encrypted files
    public static final String ENCRYPTED_DATA_FILE_NAME = "com.blackbox.pinspotdemo.encrypted_file.txt";

    public static final int MINIMUM_PASSWORD_LENGTH = 6;

    // Constants for Firebase Realtime Database
    public static final String FIREBASE_REALTIME_DATABASE = "https://pinspotdemo-default-rtdb.europe-west1.firebasedatabase.app/";
