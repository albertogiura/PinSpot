...
public final class ActivitySignupBinding implements ViewBinding {
  ...
  private ActivitySignupBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button buttonBackToLogin, @NonNull Button buttonSignup,
      @NonNull TextInputEditText edtEmailSignup, @NonNull TextInputEditText edtFullNameSignup,
      @NonNull TextInputEditText edtPasswordSignup, @NonNull Guideline guideline2,
  ...
  public static ActivitySignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignupBinding((ConstraintLayout) rootView, buttonBackToLogin, buttonSignup,
          edtEmailSignup, edtFullNameSignup, edtPasswordSignup, guideline2, textInputLayout3,
          textInputLayout4, textInputLayout5, textView3, textView4, textViewSignupAccount);
    }
