...
import com.blackbox.pinspot.model.FavouritesDB;
import com.blackbox.pinspot.model.Favourties;
...
public class LoginFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FavouritesDB db = Room.databaseBuilder(getContext(), FavouritesDB.class,
                "FavouritesDB").allowMainThreadQueries().build();
        Favourties fav1=new Favourties("pos",0.0,0.0,"https","foto",15),
                fav2 = new Favourties("posiz",1.0,1.0,"htp","prova",3);
        db.favouritesDAO().insert(fav1);
        db.favouritesDAO().insert(fav2);
        List<Favourties> favourties = db.favouritesDAO().returnAllFavourites();
        for(Favourties fav: favourties){
            Log.d("favs", fav.toString());
        }
